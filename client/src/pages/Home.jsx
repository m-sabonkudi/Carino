...
import { Car, Star, Users, Shield, ArrowRight, Filter, ArrowUp, ExternalLink } from 'lucide-react'
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <Button size={"sm"} variant="outline" className={"mb-2"} asChild>
              <Link target='_blank' className="flex items-center gap-2" to="https://testnet.explorer.onino.io/address/0x8A471A793468d85E1BD56fFe7d5A70D3fEa65621">View on Explorer <ExternalLink /> </Link>
            </Button>
            
            <h1 className="text-4xl md:text-6xl font-bold text-foreground mb-6">
              Multi-Vendor
              <span className="text-primary block">Car Bidding Platform</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button size="lg" asChild>
                <Link target='_blank' className="flex items-center gap-2 pop-animate" to="https://github.com/m-sabonkudi/Carino">View case study & source! <FaGithub/></Link>
              </Button>
            </div>
