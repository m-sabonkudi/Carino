  ...
  const values = [
    {
      icon: Target,
      title: 'Our Mission',
      description: 'To revolutionize the automotive marketplace in the world by providing a transparent, secure, and user-friendly platform for buying and selling vehicles.'
    },
    {
      icon: Eye,
      title: 'Our Vision',
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none text-muted-foreground">
            <p className="text-center mb-6">
              ...
              transparent, and trustworthy, Carino has grown from a small startup to a 
            ...
            <p className="text-center">
              Today, we're proud to serve customers across the world, connecting them with quality 
